...
operates, and present a pseudocode form of the algorithm. 
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.32]{Images/or-gate-ctrl-stg}
\par\end{centering}
\vspace{-1mm}
...
There will therefore be only one $c^{-}$ transition, requiring all three
...
$c0$ and $c1$. Figure~\ref{fig:places} shows the STG form of these.

\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.32]{Images/or-gate-ctrl-places-stg}
\par\end{centering}
\vspace{-1mm}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.32]{Images/or-gate-ctrl-loops-stg}
\par\end{centering}
\vspace{-1mm}
...
\begin{figure}[h]
\begin{centering}
\includegraphics[scale=0.32]{Images/or-gate-ctrl-inits-stg}
\par\end{centering}
\vspace{-1mm}
...
We present the algorithm for the translation of concepts to Signal Transition Graphs in
...
\For {Signals $s$ in \textbf{Inputs}}
  \State \textbf{define} interface of $s$ as \emph{Input}
\EndFor
\For {Signals $s$ in \textbf{Outputs}}
  \State \textbf{define} interface of $s$ as \emph{Output}
\EndFor
\For {Signals $s$ in \textbf{Internals}}
  \State \textbf{define} interface of $s$ as \emph{Internal}
\EndFor

\For {Each effect transition $e$}
  \For {Each list of possible causes $l$ for $e$}
    \State \textbf{add} $l$ to $allCauses$
  \EndFor
