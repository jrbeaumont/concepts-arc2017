...
\noindent The first step is to reformat these concepts into lists of causes for effects.
...
This will mean there may be several different lists for each cause transition, having this list-of-lists
will mean we can perform an operation on them in a future step, and acquire both the number of a
single transition, and the read-arcs which must connect to each of these. 
